...
ALTER TABLE USER_SUB_DIM ADD CONSTRAINT PK_USER_SUB PRIMARY KEY (USER_KEY);
...
ALTER TABLE PLATFORM_SUB_DIM ADD CONSTRAINT PK_PLATFORM_SUB PRIMARY KEY (PLATFORM_KEY);
...
ALTER TABLE USER_SUB_DIM ADD CONSTRAINT CHK_PAYMENTS_OPTION_SUB CHECK (PAYMENTS_OPTION IN ('NONE','VISA','MASTERCARD','AMERICAN EXPRESS','GIFT CARD'));
ALTER TABLE USER_SUB_DIM ADD CONSTRAINT CHK_CIVILITY_SUB CHECK (CIVILITY IN ('M','F'));
